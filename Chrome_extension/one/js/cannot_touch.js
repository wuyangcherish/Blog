...
var butt = document.getElementsByTagName('center')[0].getElementsByTagName('input')[0];
butt.onmouseover = over_btn;
var butt2 = document.getElementsByTagName('center')[0].getElementsByTagName('input')[1];
